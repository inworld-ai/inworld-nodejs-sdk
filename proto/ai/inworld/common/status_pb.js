...
goog.exportSymbol('proto.ai.inworld.common.VersionConflictDetails', null, global);
/**
 ...
 * @constructor
 */
proto.ai.inworld.common.VersionConflictDetails = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.ai.inworld.common.VersionConflictDetails, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ai.inworld.common.VersionConflictDetails.displayName = 'proto.ai.inworld.common.VersionConflictDetails';
}
 ...
 * @const
 */
proto.ai.inworld.common.InworldStatus.oneofGroups_ = [[5,6]];
...
proto.ai.inworld.common.InworldStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    versionConflict: (f = msg.getVersionConflict()) && proto.ai.inworld.common.VersionConflictDetails.toObject(includeInstance, f)
  };
...
proto.ai.inworld.common.InworldStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new proto.ai.inworld.common.VersionConflictDetails;
      reader.readMessage(value,proto.ai.inworld.common.VersionConflictDetails.deserializeBinaryFromReader);
      msg.setVersionConflict(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.ai.inworld.common.InworldStatus.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getVersionConflict();
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.ai.inworld.common.VersionConflictDetails.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional VersionConflictDetails version_conflict = 6;
 * @return {?proto.ai.inworld.common.VersionConflictDetails}
 */
proto.ai.inworld.common.InworldStatus.prototype.getVersionConflict = function() {
  return /** @type{?proto.ai.inworld.common.VersionConflictDetails} */ (
    jspb.Message.getWrapperField(this, proto.ai.inworld.common.VersionConflictDetails, 6));
};


/**
 * @param {?proto.ai.inworld.common.VersionConflictDetails|undefined} value
 * @return {!proto.ai.inworld.common.InworldStatus} returns this
*/
proto.ai.inworld.common.InworldStatus.prototype.setVersionConflict = function(value) {
  return jspb.Message.setOneofWrapperField(this, 6, proto.ai.inworld.common.InworldStatus.oneofGroups_[0], value);
};
 ...
 * @return {!proto.ai.inworld.common.InworldStatus} returns this
 */
proto.ai.inworld.common.InworldStatus.prototype.clearVersionConflict = function() {
  return this.setVersionConflict(undefined);
};
 ...
 * @return {boolean}
 */
proto.ai.inworld.common.InworldStatus.prototype.hasVersionConflict = function() {
 ...
 * @return {!Object}
 */
proto.ai.inworld.common.VersionConflictDetails.prototype.toObject = function(opt_includeInstance) {
  return proto.ai.inworld.common.VersionConflictDetails.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.ai.inworld.common.VersionConflictDetails} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ai.inworld.common.VersionConflictDetails.toObject = function(includeInstance, msg) {
  var f, obj = {
    clientVersion: jspb.Message.getFieldWithDefault(msg, 1, 0),
    serverVersion: jspb.Message.getFieldWithDefault(msg, 2, 0),
    requestIndex: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
 ...
 * @return {!proto.ai.inworld.common.VersionConflictDetails}
 */
proto.ai.inworld.common.VersionConflictDetails.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ai.inworld.common.VersionConflictDetails;
  return proto.ai.inworld.common.VersionConflictDetails.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ai.inworld.common.VersionConflictDetails} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ai.inworld.common.VersionConflictDetails}
 */
proto.ai.inworld.common.VersionConflictDetails.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ai.inworld.common.VersionConflictDetails.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ai.inworld.common.VersionConflictDetails.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ai.inworld.common.VersionConflictDetails} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ai.inworld.common.VersionConflictDetails.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.ai.inworld.common.VersionConflictDetails.prototype.getClientVersion = function() {
...
/**
 * @param {number} value
 * @return {!proto.ai.inworld.common.VersionConflictDetails} returns this
 */
proto.ai.inworld.common.VersionConflictDetails.prototype.setClientVersion = function(value) {
 ...
 * @return {number}
 */
proto.ai.inworld.common.VersionConflictDetails.prototype.getServerVersion = function() {
 ...
 * @return {!proto.ai.inworld.common.VersionConflictDetails} returns this
 */
proto.ai.inworld.common.VersionConflictDetails.prototype.setServerVersion = function(value) {
 ...
 * @return {number}
 */
proto.ai.inworld.common.VersionConflictDetails.prototype.getRequestIndex = function() {
 ...
 * @return {!proto.ai.inworld.common.VersionConflictDetails} returns this
 */
proto.ai.inworld.common.VersionConflictDetails.prototype.setRequestIndex = function(value) {
