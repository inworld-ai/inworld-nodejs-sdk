...
goog.exportSymbol('proto.ai.inworld.options.SerializationOption', null, global);
 ...
 * @enum {number}
 */
proto.ai.inworld.options.SerializationOption = {
...
/**
 * A tuple of {field number, class constructor} for the extension
 * field named `serializationOption`.
 * @type {!jspb.ExtensionFieldInfo<!proto.ai.inworld.options.SerializationOption>}
 */
proto.ai.inworld.options.serializationOption = new jspb.ExtensionFieldInfo(
    10086,
    {serializationOption: 0},
    null,
     /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (
         null),
    0);

google_protobuf_descriptor_pb.FieldOptions.extensionsBinary[10086] = new jspb.ExtensionFieldBinaryInfo(
    proto.ai.inworld.options.serializationOption,
...
// This registers the extension field with the extended class, so that
// toObject() will function correctly.
google_protobuf_descriptor_pb.FieldOptions.extensions[10086] = proto.ai.inworld.options.serializationOption;
